...
export default function Payment({ userid }: { userid: string }) {
    ...
    }, [order_status, order_id, orderStatus, dispatch]);
            ...
            {step === 4 ? (
                <>
                    ...
                    <div className="px-4 py-3 bg-grey3">
                        {orderStatus === 'loading' ? (<div className="text-theme1">
                            ...
                            {order && (
                                <button type="submit" className="btn1 d-block font-primary mt-3 py-2 px-4">
                                    Confirm Order
                                </button>
                            )}
                        </form>)}
