...
export default function Grid3() {
    return (
        <Col xs={12} lg={4}>
            <h5 className="text-black font-h3 fw-4">Newsletter</h5>
            ...
            <Image src={"/images/payment-method.png"} alt="payment-methods" width={634} height={29} className="w-100 h-auto mt-5" />
        </Col>
    )
}