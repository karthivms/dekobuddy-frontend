                    ...
                    {cartproducts.length > 0 ? (<>
                                    ...
                                    <tbody className="">
                                        {cartproducts.map((product: cartItem) => (
                                            <tr key={`cart_items_${product.id}_${product.product.id}`} >
                                                ...
                                                <td>
                                                    <QuanityHandler page={'cart'} stock={product.product.stock} cartid={product.id} userid={Number(userid)} count={product.product.quantity} />
                                                </td>
                        ...
                        <div className="d-flex justify-content-center align-items-center py-3">
                            <div className="text-center">
                                <Image src={'/images/empty-cart.webp'} width={485} height={380} className='wp-350 h-auto' alt="empty_cart" />
